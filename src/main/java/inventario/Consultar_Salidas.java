    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(4, 4, 4)
                .addComponent(etiquetaAlmacenActivo, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
          ...
          //llamo primero a los codigos de los articulos que estan en el historial del documento llamado
           ...
           //ya que si esta en temporal, solo llama datos no hace validaciones
            ...
            if( modelo.getValueAt(tabla_salidas.getSelectedRow(), 5).toString().equals("Guardado") )
            {
                    ...
                    temp.settotaloperacion(Double.valueOf(modelo.getValueAt(tabla_salidas.getSelectedRow(),4 ).toString()));
                    ...
                    ventana.setValorDespachoRec(buscar.getValorPedidoDoc());
