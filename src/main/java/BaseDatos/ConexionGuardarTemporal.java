...
public class ConexionGuardarTemporal {
    ...
    String codigo_almacen;//para la entrada
    String almacen_despacho;//para la salida
    String almacen_destino;//para la salida
                  ...
                  try
                         {
                            ...
                            {
                            consulta= conex.prepareStatement("insert into temporal_articulo values (DEFAULT, ?, ?, ?, ?, ?, ?, 0)");//se guarda 0 en el valor del pedido ya que este campo es para la salida
