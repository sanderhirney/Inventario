...
public class ConfiguracionBaseDatosPublic {
    ...
    Flyway flyway=Flyway.configure()
            ...
            .load();
         // Esto te dirá qué versión detectó Flyway antes de migrar
        //System.out.println("Versión actual: " + flyway.info().current().getVersion());
                //carga
                flyway.migrate();
                
                log.info("CONFIGURACION INICIAL DE ADMIN BD CREADA");
